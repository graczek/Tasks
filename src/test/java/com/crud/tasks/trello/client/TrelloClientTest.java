...
public class TrelloClientTest {
    ...
    public void init() {
        ...
        when(trelloConfig.getTrelloUsername()).thenReturn("raczekgrz");
    }
    ...
    public void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        System.out.println(trelloBoards[0]);

        URI uri = new URI("http://test.com/members/raczekgrz/boards?key=test&token=test&fields=name,id&lists=all");
